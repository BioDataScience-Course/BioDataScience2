...
Tracez un graphique des nitrates `nit` en fonction de l'oxygène dissout `oxy`. Regroupez les stations par de la couleur en utilisant les groupes que vous avez calculés et représentez les centres sur votre graphique.
...
<!-- Ce serait bien de rajouter ici une comparaison entre CAH et K-means, puisqu'on a utilisé les mêmes données ! -->
...
<!-- Ici ce serait peut être bien d'afficher la matrice de distance obtenue. Actuellement, le code ne renvoie rien, mais indique un avis (à cause de la station 8 vide)... Un commentaire là-dessus serait aussi utile, à moins de l'éliminer de l'analyse. -->
