...
question("Quelle partie du cours évaluez-vous ?",
  ...
  answer("Module 4 : Régression non linéaire", correct = TRUE),
  answer("**AA modélisation (Q1, modules 1-4)**", correct = TRUE),
  answer("Module 5 : Classification hiérarchique", correct = TRUE),
  answer("Module 6 : K-moyenne, MDS & SOM", correct = TRUE),
  answer("Module 7 : ACP & AFC", correct = TRUE),
  answer("Module 8 : AFM, biodiversité et Open Data", correct = TRUE),
