...
description: "**SDD II Module 6** Réaliser et analyser un positionnement multidimensionnel (MDS)."
tutorial:
  id: "B06Lb_mds"
  version: 2.0.1/8
output:
...
Félicitation ! Vous venez de terminer votre auto-évaluation relative au positionnement multidimensionnel. Vous maîtrisez maintenant les notions et fonctions de base nécessaires pour la réalisation ce type d'analyse et vous pouvez vous lancer dans le projet relatif à cette matière.
