...
```{r, echo = TRUE}
# Graphique de otre objet `lm`
chart(rice_lm)
# Tableau relatif à la paramétrisation du modèle
tabularise$tidy(rice_lm)
```

Vous avez à votre disposition l'objet `rice_lm`. Proposez quatre graphiques afin d'étudier la distribution des résidus, le graphique quantile-quantile des résidus, la position et l'échelle des résidus et la distance de Cook des résidus.
